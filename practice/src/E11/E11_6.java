...
public class E11_6 {
	...
	static int getGroupConunt(TreeSet tset, int from, int to) {
	...
	public static void main(String[] args) {
		...
		set.add(new Student1("홍킬동",1,1,100,100,100));
		...
		System.out.println(getGroupConunt(set, 60, 70));
		System.out.println(getGroupConunt(set, 70, 80));
		System.out.println(getGroupConunt(set, 80, 90));
		System.out.println(getGroupConunt(set, 90, 101));
	}
